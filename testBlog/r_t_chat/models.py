...
class ChatGroup(models.Model):
    ...
    members = models.ManyToManyField(get_user_model(), related_name='chat_groups', blank=True)
    is_private = models.BooleanField(default=False)
    user_online = models.ManyToManyField(get_user_model(), related_name="online_in_groups", blank=True)
