...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slot_duration', models.PositiveIntegerField(blank=True, help_text='(Количество слотов доступных для записи к данному работнику, день будет разбит на промежутки по установленному количеству минут)', null=True)),
                ('lead_time', models.TimeField(blank=True, help_text='Время начала рабочего дня', null=True)),
                ('finish_time', models.TimeField(blank=True, help_text='Время конца рабочего дня', null=True)),
                ('appointment_buffer_time', models.FloatField(blank=True, help_text='Время между текущим моментом и первым доступным интервалом на текущий день (не влияет на завтра)', null=True)),
